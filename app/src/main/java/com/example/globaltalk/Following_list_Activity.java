...
public class Following_list_Activity extends AppCompatActivity {
    ...
    private ArrayList<FollowingData> fArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_following_list_);
        ...
        fRecyclerView = (RecyclerView) findViewById(R.id.listView_following_list);
        ...
        fAdapter = new FollowingAdapter(this, fArrayList);
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String serverURL = "http://54.180.122.247/global_communication/following_list.php";
            String postParameters = "following_email=" + searchKeyword1 ;
    ...
    private void showResult(){
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                followingData.setMember_email(email);
                followingData.setMember_image(image);
                followingData.setMember_name(name);
                followingData.setMember_teach(teach);
                followingData.setMember_learn(learn);

                fArrayList.add(followingData);
                fAdapter.notifyDataSetChanged();
            }
